...
const SEASON_GROUPS: { season: Season; months: MonthCard[]; label: string }[] =
  [
    {
      season: "봄",
      label: "봄 (3~5월)",
      months: MONTHS.filter((m) => m.season === "봄"),
    },
    {
      season: "여름",
      label: "여름 (6~8월)",
      months: MONTHS.filter((m) => m.season === "여름"),
    },
    {
      season: "가을",
      label: "가을 (9~11월)",
      months: MONTHS.filter((m) => m.season === "가을"),
    },
    {
      season: "겨울",
      label: "겨울 (12~2월)",
      months: MONTHS.filter((m) => m.season === "겨울"),
    },
  ];
  ...
  return (
    <>
      ...
      <main className="flex-1">
        ...
        >
          ...
          >
            ...
            <p
              style={{
                fontSize: "16px",
                color: "var(--color-forest-100, rgba(255,255,255,0.85))",
                maxWidth: "480px",
                lineHeight: 1.6,
                margin: 0,
              }}
            >
              봄·여름·가을·겨울, 계절마다 달라지는 최고의 야영지를
              소개합니다.
            </p>
          </div>
        </div>
        ...
        >
          {SEASON_GROUPS.map(({ season, label, months }) => (
            <section key={season} style={{ marginBottom: "56px" }}>
              <h2
                style={{
                  fontSize: "20px",
                  fontWeight: 800,
                  ...
                  marginBottom: "20px",
                  paddingBottom: "10px",
                  borderBottom: `3px solid ${SEASON_ACCENT[season]}`,
              ...
              >
                {months.map((m) => (
                  <a
                    ...
                    aria-label={`${m.korean} 추천 야영지 — ${m.short}`}
                  >
                    <div
                      style={{
                        display: "flex",
